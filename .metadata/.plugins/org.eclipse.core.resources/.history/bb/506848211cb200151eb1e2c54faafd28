...
public class ServicesServiceLocator extends org.apache.axis.client.Service implements webservice.ServicesService {
    ...
    private java.lang.String Services_address = "http://localhost:8080/tomcat_testing/services/Services";
    ...
    public webservice.Services getServices() throws javax.xml.rpc.ServiceException {
    ...
    public webservice.Services getServices(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            webservice.ServicesSoapBindingStub _stub = new webservice.ServicesSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (webservice.Services.class.isAssignableFrom(serviceEndpointInterface)) {
                webservice.ServicesSoapBindingStub _stub = new webservice.ServicesSoapBindingStub(new java.net.URL(Services_address), this);
                _stub.setPortName(getServicesWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice", "ServicesService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice", "Services"));
        }
